...
function ManageWorkshop() {
  ...
  const [workshopEdit, setWorkshopEdit] = useState({
    title: "",
    label: "",
    text: "",
    date: "",
  ...
  return (
    <section className="text-center">
      <div className="title">
        ...
        <span className="text">Manage Workshops</span>
      </div>

      <div className="customize-method">
        <PrimaryButton
          text1={"Create a new Workshop"}
          text2={"Let's Create!"}
          fnx={() =>
            setSelect({
              details: false,
      ...
      {select.registrations && (
        <WorkshopRegistrations
          registrationsState={[registrations, setRegistrations]}
        />
      )}
      ...
      {select.add && (
        <>
          ...
          <WorkshopForm
            workshopState={[workshopEdit, setWorkshopEdit]}
      ...
      {select.details && (
        <>
          <Filter
            filter={{ options: ["All", "Current", "Past"], select: filter }}
            setState={setFilter}
          />
          {(filter == "All" || filter == "Current") && (
            <>
              ...
              <WorkshopTable
                ...
                setWorkshops={setCurrentWorkshops}
                setStates={[
                  setCurrentWorkshops,
                  setRegistrations,
                  setSelect,
